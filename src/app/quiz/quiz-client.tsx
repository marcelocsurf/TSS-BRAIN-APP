...
// TSS brand tokens (Brand Manual): Ocean Navy + Signature Cyan, Lora headings.
const ACCENT = '#5AC3E7';
const DEEP = '#0A1628';
      ...
      <div style={{ maxWidth: 540, margin: '0 auto', padding: '0 20px', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        {screen === 'intro' && (
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            ...
            <h1 style={{ fontFamily: HEAD, fontSize: '2.6rem', lineHeight: 1.1, margin: '20px 0' }}>
        ...
        {screen === 'prime' && (
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            ...
            <h2 style={{ fontFamily: HEAD, fontSize: '1.7rem', margin: '10px 0 10px' }}>
        ...
        {screen === 'gate' && (
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            <div style={{ fontSize: '2.2rem' }}>🌊</div>
            <h2 style={{ fontFamily: HEAD, fontSize: '1.7rem', margin: '10px 0 6px' }}>
        ...
        {screen === 'quiz' && (() => {
          ...
          return (
            <div style={{ padding: '24px 0' }}>
              ...
              <div style={scenario}><div style={{ fontFamily: HEAD, fontSize: '1.3rem', lineHeight: 1.35 }}>{q.scenario}</div></div>
        ...
        {screen === 'result' && (
          <div style={{ textAlign: 'center', padding: '40px 0' }}>
            ...
            <div style={{ fontFamily: HEAD, fontSize: '2rem', color: level.color }}>{level.name}</div>
...
const chip: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(90,195,231,.12)', border: '1px solid rgba(90,195,231,.2)', borderRadius: 24, padding: '6px 16px', fontSize: '.72rem', fontWeight: 700, color: ACCENT, letterSpacing: '.8px', textTransform: 'uppercase' };
