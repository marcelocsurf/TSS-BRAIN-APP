...
export default async function LibraryPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 rounded-lg border border-[#DCD7C6] bg-[#F7F9FA] p-4 flex items-center gap-3">
        <span className="w-10 h-10 rounded-[5px] bg-[var(--tss-navy)]/5 text-[var(--tss-navy)] flex items-center justify-center shrink-0">
