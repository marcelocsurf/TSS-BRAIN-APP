...
export default async function EditCampTemplatePage({ params }: Props) {
  ...
  const initialData: CreateTemplateInput = {
    ...
    includes_course_key: template.includes_course_key ?? null,
    ...
    needs_venue: template.needs_venue !== false,
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-[#55666E] mt-1">{template.template_name}</p>
        </div>
