...
export const CIRCLES: Circle[] = [
  ...
  },
  {
    ...
    response: [
      { title: 'Press the back foot and the board brakes', note: 'Push through the back foot and the tail sinks into the water. The board slows down. That is your brake, and you use it on purpose: to wait for a section, to hold a line, to turn tight. You press the tail. You never fall back onto it.' },
