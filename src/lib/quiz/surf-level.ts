...
export const LEVELS: QuizLevel[] = [
  { name: 'Beginner', belt: 'white_belt', min: 0, max: 9, color: '#9AA7AD',
  ...
  { name: 'Novice', belt: 'yellow_belt', min: 10, max: 29, color: '#F5C518',
    rt: 'Why this level matters',
  ...
  { name: 'Foundation', belt: 'blue_belt', min: 30, max: 44, color: '#1E6FBF',
  ...
  { name: 'Emerging', belt: 'purple_belt', min: 45, max: 56, color: '#7B4FBE',
  ...
  { name: 'Pre-Elite', belt: 'brown_belt', min: 57, max: 65, color: '#7D4E27',
    rt: 'The final gap',
  ...
  { name: 'Elite', belt: 'black_belt', min: 66, max: 70, color: '#2C2C2A',
