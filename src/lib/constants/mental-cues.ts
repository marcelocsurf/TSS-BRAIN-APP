...
//     repetición (cap. 7), así que una frase suelta contradice su propia tesis.
//
...
export const BELT_MIRROR: Record<string, string> = {
  ...
  black_belt:
    'You are not chasing the next level. You are mastering this one. The work is subtle and the margins are small.',
};
...
export const MENTAL_CUES: Record<string, MentalCue[]> = {
  white_belt: [
    ...
    { cue: 'The breath is the one part of your nervous system you control on purpose. Fight discomfort and it wins. Slow the breath and it changes.', today: 'Three slow breaths before you paddle out.' },
  ...
  yellow_belt: [
    ...
    { cue: 'Progress here is your worst session improving, not your best.', today: 'Judge the session by your worst wave.' },
  ...
  blue_belt: [
    ...
    { cue: 'Frustration is not a verdict on your ability. It is information — your nervous system being asked for something it cannot do automatically yet.', today: 'Name what it is telling you, then take the next wave.' },
  ...
  purple_belt: [
    { cue: 'Flow lives between boredom and anxiety. Too easy and the mind wanders. Too hard and the body tightens.', today: 'Was it too easy or too hard? Adjust the next one.' },
  ...
  brown_belt: [
    { cue: 'Pressure does not have to break flow. It can calibrate the challenge to exactly the level that requires everything you have.', today: 'Let the pressure set the level instead of lowering it.' },
    ...
    { cue: 'Adaptation happens during recovery, not during training. The skill is built while you sleep.', today: 'If the plan says rest, resting is the training.' },
  ...
  black_belt: [
    { cue: 'The nervous system does not adapt to understanding. It adapts to repetition.', today: 'Take one idea into the water instead of reading one more.' },
